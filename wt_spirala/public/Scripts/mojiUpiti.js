document.addEventListener("DOMContentLoaded", () => {
    ...
    function prikaziUpite(upiti) {
        ...
        // Dodajemo listu u kontejner
        upitiContainer.appendChild(lista);
    }

    // Dohvatanje upita trenutno prijavljenog korisnika
